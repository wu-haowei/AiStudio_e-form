                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="p-6 bg-gray-50 rounded-3xl border border-gray-100 space-y-3">
                      ...
                      <ul className="text-sm text-gray-600 space-y-2">
                        <li>• <strong>權限分配：</strong>設定使用者的系統角色 (管理者/一般用戶)。</li>
                        <li>• <strong>組織架構：</strong>調整使用者所屬單位，影響表單的可見範圍。</li>
                        <li>• <strong>帳號維護：</strong>管理全系統使用者的基本資訊與狀態。</li>
                      </ul>
                    </div>
                  </div>
                </div>
